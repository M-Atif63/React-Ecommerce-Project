...
import { auth, signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider } from '../../Firebase.jsx'
    ...
    return (
        <div className="signup-container">
            <div className="signup-card">
                ...
                <button className='cont-with-google-btn' onClick={handleGoogleLogin}>
